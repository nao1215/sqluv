...
func (m *MockHistoryCreator) Create(ctx context.Context, t *model.Table) error {
	m.ctrl.T.Helper()
...
func (mr *MockHistoryCreatorMockRecorder) Create(ctx, t any) *MockHistoryCreatorCreateCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockHistoryCreator)(nil).Create), ctx, t)
...
// Do rewrite *gomock.Call.Do
func (c *MockHistoryCreatorCreateCall) Do(f func(context.Context, *model.Table) error) *MockHistoryCreatorCreateCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockHistoryCreatorCreateCall) DoAndReturn(f func(context.Context, *model.Table) error) *MockHistoryCreatorCreateCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
